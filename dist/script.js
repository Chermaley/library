...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.carousel = function ({
  ...
  for (let i = 0; i < this.length; i++) {
    ...
    const slidesField = this[i].querySelector('.carousel-slides'); //Задаем обертку c шириной всех слайдов
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.modal = function (created) {
  for (let i = 0; i < this.length; i++) {
    const target = Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(this[i]).getAtt('data-target');
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.deleteAtt = function (attributeName, value) {
  for (let i = 0; i < this.length; i++) {
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').click(() => Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').createModal({
  ...
  btns: {
    count: 3,
    settings: [['Close', ['btn-dander', 'mr-10'], true], ['Save changes', ['btn-success'], false, () => {
      alert('Данные сохранены');
    }], ['sasa', ['btn-warning', 'ml-10'], false, () => {
      alert('1');
    }]]
  }
}));
