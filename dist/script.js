...
window.$ = $;
/* harmony default export */ __webpack_exports__["default"] = ($); //Когда мы вызываем функцию $, она возвращает новый созданный объект, который имеет все её методы и свойства
...
/* harmony import */ var _modules_attribute__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/attribute */ "./src/js/lib/modules/attribute.js");
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.find = function (selector) {
  let numberOfItems = 0;
  let counter = 0; //Создаем и работаем с копией объекта чтобы избежать баги
  ...
  const objLength = Object.keys(this).length; //Удаляем лишние элементы с конца
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.siblings = function () {
  ...
  for (let i = 0; i < copyObject.length; i++) {
    ...
    const arr = copyObject[i].parentNode.children; //Записываем элементы в изначальный объект

    for (let j = 0; j < arr.length; j++) {
      if (copyObject[i] === arr[j]) {
        //Пропускаем элемент на котором произошло действие
        continue;
      }
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.addAtt = function (attributeName, value) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.deleteAtte = function (attributeName, value) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.toggleAtt = function (attributeName, value) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.fadeIn = function (dur, display, fin) {
  for (let i = 0; i < this.length; i++) {
    this[i].style.display = display || 'block'; //Используем стрелочную функцию, чтобы сохранить контекст 
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.fadeTo = function (dur, opacity, fin) {
  for (let i = 0; i < this.length; i++) {
    if (opacity > 1) {
      opacity = 1;
    }

    const _fadeTo = complection => {
      this[i].style.opacity = 1 - (1 - opacity) * complection;
    };

    const ani = this.animateOverTime(dur, _fadeTo, fin);
    requestAnimationFrame(ani);
  }
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#first').on('click', () => {
  Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('div').eq(1).fadeToggle(850);
});
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('[data-count="second"]').on('click', () => {
  Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('div').eq(2).fadeToggle(850);
});
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('button').eq(2).on('click', () => {
  Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.w-500').fadeToggle(850);
});
